					...
					<div class="summary">
						...
						<div class="summary-wrap">
							...
							<div class="fl fix-width">
								...
								<em class="t-gray">满999.00另加20.00元，或满1999.00另加30.00元，
									或满2999.00另加40.00元，即可在购物车换 购热销商品</em>
							</div>
						</div>
					</div>
					<div class="support">
								...
								<dl>
									...
									<#list spec.attributeValue as option>
										<dd>
											<!-- selected -->
											<a href="javascript:;"
											   class="{{isSelected('${spec.attributeName}','${option}') ? 'selected' : ''}}"
											   ng-click="selectedSpec('${spec.attributeName}', '${option}');">${option}
